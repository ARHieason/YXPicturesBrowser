...
@implementation YXPictureIndicator
...
+ (instancetype)showInView:(UIView *)view {
    ...
    YXPictureIndicator *pictureIndicator = [[YXPictureIndicator alloc] initWithFrame:CGRectMake(0, 0, 50, 50)];
