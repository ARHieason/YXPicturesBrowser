...
#import "YXPictureIndicator.h"
#import "YXPictureManager.h"

@interface YXPictureView () <UIScrollViewDelegate>

@property (nonatomic, strong) YXPictureIndicator *pictureIndicator;

@end

@implementation YXPictureView
...
- (void)setPictureModel:(YXPictureModel *)pictureModel {
    ...
    if (self.pictureModel.picture) {
        ...
        _pictureIndicator = [YXPictureIndicator showInView:self];
        [YXPictureManager downloadPicture:self.pictureModel.picURLString success:^(UIImage *picture) {
            _pictureIndicator = [_pictureIndicator hide];
            _pictureIndicator = nil;
